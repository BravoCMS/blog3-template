...
<{block name="module"}>
        ...
        <div class="article_details article_details_news full">
            ...
            <span class="article_full_img_block">
                <span class="article_full_img">
                    <img src="<{$article.cover.photo_file}>" alt="pic">
                </span>
            </span>
    ...
    <{get_discussion "d iscussion" "pagination" element=$article page_query}>
    <{if $discussion.is_active}>
        ...
        <{else}>
            <a href="" class="btn btn-primary" id="discussion-anchor">
